...
import { buildRoundPrompt, parseRoundOutput, type RoundOutput } from '@/agent/research/round'
import { MAX_SCOUTS, SCOUT_TIMEOUT_MS, type RoundResult } from '@/agent/research/state'
import type { SubrequestBudget } from '@/agent/subrequest-budget'
import { runToolLoop } from '@/agent/loop/tool-loop'
import { browserTools } from '@/agent/tools/browser.tools'
import { searchTools } from '@/agent/tools/search.tools'
import { readToolResultTool } from '@/agent/tools/tool-archive.tools'
import { pageKey, type ToolContext } from '@/agent/tools/registry'
